...
- [ ] Unit-тесты для /start: корректная статистика (tasks, notes, pending_tasks)
- [ ] Unit-тесты для /start: форматирование сообщения, список команд
- [ ] Unit-тесты для /summarize: сброс таймера, вызов auto_summarize
- [ ] Unit-тесты для /inbox: просмотр инбокса с сообщениями, пустой инбокс
- [ ] Unit-тесты для /tasks: список задач со статусами, пустой список задач
- [ ] Unit-тесты для /task done: валидация аргументов, обновление статуса задачи
- [ ] Unit-тесты для /task done: обработка несуществующей задачи
- [ ] Unit-тесты для /notes: список заметок, пустой список заметок
- [ ] Unit-тесты для /settings: парсинг аргументов, установка задержки, обновление таймера
- [ ] Unit-тесты для /settings: обработка некорректных аргументов
- [ ] Unit-тесты для /clear: очистка инбокса, обработка некорректных аргументов
- [ ] Integration-тесты: все команды с реальной базой данных через FileManager
- [ ] Edge cases: команды без аргументов, команды с лишними аргументами, unicode в сообщениях